...
- (void)reloadData {
    ...
    if (_gridController )//&& !didAnimate) {
        [_gridController.collectionView reloadData];
    //    } else if( didAnimate )
    //    {
    //                [_gridController.collectionView reloadItemsAtIndexPaths:[_gridController.collectionView indexPathsForVisibleItems]];
    //
    //
    //    }
    //
...
- (void)showGrid:(BOOL)animated {
    ...
    _collectionView = _gridController.collectionView;
